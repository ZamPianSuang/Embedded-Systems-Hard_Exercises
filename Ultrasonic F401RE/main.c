...
unsigned char seg_one[]={0x3F, 0x06, 0x5B, 0x4F, 0x66,0x6D, 0x7D,0x07, 0x7F, 0x6F}; 
unsigned char seg_two[]={0x3F, 0x06, 0x5B, 0x4F, 0x66,0x6D, 0x7D,0x07, 0x7F, 0x6F};
...
int main(void)
{
	...
	while(1)
	{
		...
		GPIOB->ODR = seg_one[distance/10];
		GPIOC->ODR = seg_two[distance%10];

		delayUs(5000);			// half second
